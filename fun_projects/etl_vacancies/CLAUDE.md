This is a small project focused on simplicity and readability.

Infrastructure:
- The project is hosted in a public GitHub repository on the `etl_vacancies` branch.
- The application runs inside a Docker container locally.
- Application configuration is provided through environment variables defined in a `.env` file.
Guidelines:
- Prefer simple and idiomatic solutions.
